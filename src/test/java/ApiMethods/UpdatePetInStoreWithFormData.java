//This test case is written to Update a pet to the store
...
public class UpdatePetInStoreWithFormData {
	
	//This method will provide data to any test method that declares that its Data Provider
	@DataProvider (name = "data-provider")
	 public Object[][] dpMethod(){
	 return new Object[][] {{100,"Hund", "sold"}, {101,"Katze-new", "pending"}, {102,"Parrot-new", "available"}, {103,"Sparrow-new","available"}};
	 }
	
	@Test (dataProvider = "data-provider")
	void UpdatePetInStore(int idNo, String name, String status) {
		...
		System.out.println("Updating a pet details");
